...
export class DriveSubsystem {
    ...
    get ODrive(): Drive { return this._ODrive; }
    get PDrive(): Drive { return this._PDrive; }

    get history() { return this._history; }

    // Legacy compatibility getters (aliases for visualization)
    get ODriveFloor() { return this._ODrive.floor; }
    get ODriveLowerLimit() { return this._ODrive.lowerLimit; }
    get ODriveUpperLimit() { return this._ODrive.upperLimit; }
    get ODriveMax() { return this._ODrive.max; }

    get PDriveFloor() { return this._PDrive.floor; }
    get PDriveLowerLimit() { return this._PDrive.lowerLimit; }
    get PDriveUpperLimit() { return this._PDrive.upperLimit; }
    get PDriveMax() { return this._PDrive.max; }
