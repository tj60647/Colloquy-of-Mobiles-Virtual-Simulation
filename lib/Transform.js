...
export class Transform {
  ...
  constructor(
    ...
    if (parent && !(parent instanceof Transform)) {
      throw new Error('Transform: Parent must be an instance of Transform or null.');
    }
  ...
  parentHasChanged() {
    ...
    return (
      JSON.stringify(this.#lastParentGlobalPosition) !== JSON.stringify(currentParentPosition) ||
