export class Render3Dp5 {
  ...
  static drawDashedLine(x1, y1, z1, x2, y2, z2, dashLength, gapLength) {
    ...
    for (let i = 0; i < numDashes; i++) {
      ...
      line(currentPos.x, currentPos.y, currentPos.z, nextPos.x, nextPos.y, nextPos.z);
  ...
  static drawActuatorFOV(actuator) {
    Render3Dp5.drawFOV(actuator, actuator.fieldOfView, 'rgba(255, 0, 0, 100)', 30);
  }
