...
export class Oscillator {
  ...
  constructor(
    ...
    if (minPosition >= maxPosition) {
      throw new Error("Oscillator.constructor: 'minPosition' must be less than 'maxPosition'.");
    }
    ...
    if (tolerance < 0) {
      throw new Error("Oscillator.constructor: 'tolerance' must be a non-negative value.");
    }
    if (frameRate <= 0) {
      throw new Error("Oscillator.constructor: 'frameRate' must be a positive value.");
    }
    if (maxVelocity <= 0) {
      throw new Error("Oscillator.constructor: 'maxVelocity' must be a positive value.");
    }
    if (maxAcceleration <= 0) {
      throw new Error("Oscillator.constructor: 'maxAcceleration' must be a positive value.");
    }
    if (maxJerk < 0) {
      throw new Error("Oscillator.constructor: 'maxJerk' must be a non-negative value.");
    }
